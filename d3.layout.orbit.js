d3.layout.orbit = function() {
	...
	_orbitLayout.state = function(){
		return state
	}

	_orbitLayout.rebind = function(){
		orbitDispatch = d3.dispatch('tick');
		d3.rebind(_orbitLayout, orbitDispatch, "on");

		console.log("rebind", tickInterval, orbitDispatch)
		return _orbitLayout
	}
	...
	_orbitLayout.clear_tick = function() {
	...
	_orbitLayout.start = function() {
		...
		tickInterval = setInterval(
			...
			// if (currentTickStep%100==0){
			// 	console.log("setinterval", currentTickStep, flattenedNodes)
			// }
	...
	_orbitLayout.stop = function() {
		...
		console.log("clear", tickInterval)
		clearInterval(tickInterval);
		state = "STOPPED"
